...
require_once __BACKYARDROOT__.'../../../../../lib/google-api-php-client-2012/src/apiClient.php'; //140414 - adding -2012 (for making it work for Stakan2 prior to backyard2 migration) will disable the module, but it is not used anymore, anyway :)
require_once __BACKYARDROOT__.'../../../../../lib/google-api-php-client-2012/src/contrib/apiPlusService.php';
require_once __BACKYARDROOT__.'../../../../../lib/google-api-php-client-2012/src/contrib/apiOauth2Service.php';//http://stackoverflow.com/questions/8706288/using-google-api-for-php-need-to-get-the-users-email
